...
# docs/ENVELOPE.md against the shim's policy table. A document that says
# "supported" about a feature the code refuses is worse than no document.
stage envelope       bash Tests/run_envelope_tests.sh
stage docs           bash Tests/run_docs_tests.sh
